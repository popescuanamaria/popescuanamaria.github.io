          ...
          <div className="flex flex-col items-center w-full sm:max-w-4xl pt-5 pb-20 gap-y-10">
            ...
            <div className="flex justify-end w-full">
              <div className="flex flex-col items-start pl-3 pr-3 w-3/4 border-l-2 border-[#888888] border-opacity-50 sm:w-1/2">
                ...
                <div className="font-normal text-lg opacity-70">
                  2011 - 2015
                </div>
              </div>
            </div>
              ...
              <div className="flex flex-col items-end pl-6 pr-3 w-3/4 border-r-2 border-[#888888] border-opacity-50 sm:w-1/2">
                ...
                <ul className="list-disc">
                  <li>
                    ...
                    sensor. The objective was to achieve the highest-quality
                    image, and my responsibilities included conducting research
                    and analyzing outcomes in various scenarios. This involved
                    incorporating new implementations for different filters in
                    the pipeline, adjusting parameters, and more.
                  </li>
                </ul>
              </div>
            </div>
              ...
              <div className="flex flex-col items-start pl-6 pr-3 w-3/4 border-l-2 border-[#888888] border-opacity-50 sm:w-1/2">
                ...
                <ul className="list-disc">
                  ...
                  <li>
                    ...
                    projects for diverse clients, incorporating new filters and
                    optimizing code in assembly language. Additionally, provided
                    on-site support for clients, ensuring seamless integration
                    and optimal performance of the implemented enhancements.
                  </li>
                </ul>
              </div>
            </div>
              ...
              <div className="flex flex-col items-end pl-6 pr-2 w-3/4 border-r-2 border-[#888888] border-opacity-50 sm:w-1/2">
                ...
                <ul className="list-disc">
                  <li>
                    ...
                    (Convolutional Neural Network) hardware block for
                    verification purposes, with a specific emphasis on
                    byte-level transactions. The model was required to simulate
                    each sub-block, along with handling transactions between
                    sub-blocks and interactions between memory and the CNN unit.
                  </li>
                  <li>
                    Integrated various computer vision hardware blocks into our
                    proprietary architecture, enhancing existing blocks with
                    additional features (e.g. Stereo, Matrix Multiplication,
                    Event Processing Unit). Conducted low-level verification
                    using SystemVerilog.
                  </li>
                  <li>
                    Extended our Python and C++ compiler for CNN models with new
                    operations. Integrated an arithmetic emulator for reference
                    result validation and utilized the compiler to generate
                    diverse datasets for power and performance measurements on a
                    specific neural network hardware block.
                  </li>
                  <li>
